...
//react loader function. params is to get the url parameters instead of useParams which can only be used inside a component. then connect it to the path on the app.jsx
