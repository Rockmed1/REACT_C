...
function Order() {
  ...
  //to get the menu data without being on the menu page:
...
//1) create react loader function. params is to get the url parameters instead of useParams() hook which can only be used inside a component.
