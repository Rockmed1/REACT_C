"use client";
//use client because we are using a react hook useReservation so it cannot be a client component
...
function ReservationReminder() {
  ...
  return (
    <div className="bg-accent-500 text-primary-800 text fixed bottom-6 left-1/2 flex -translate-x-1/2 items-center gap-8 rounded-full px-8 py-5 font-semibold shadow-xl shadow-slate-900">
      ...
      <button className="hover:bg-accent-600 rounded-full p-1 transition-all">
